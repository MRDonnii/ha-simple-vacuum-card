...
class HASimpleVacuumCard extends HTMLElement {
  ...
  static getStubConfig() {
    return {
      ...
      vacuum: "vacuum.leonora",
      battery: "sensor.leonora_batteri",
      bin_full: "binary_sensor.leonora_bin_full",
      average_mission_time: "sensor.leonora_average_mission_time",
      battery_cycles: "sensor.leonora_battery_cycles",
      missions_total: "sensor.leonora_total_missions",
      missions_successful: "sensor.leonora_successful_missions",
      missions_failed: "sensor.leonora_failed_missions",
      missions_canceled: "sensor.leonora_canceled_missions",
      total_cleaning_time: "sensor.leonora_total_cleaning_time",
      tank_level: "sensor.leonora_tank_level",
      dock_tank_level: "sensor.leonora_dock_tank_level",
    };
  }
  setConfig(config) {
